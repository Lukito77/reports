...
const translations = {
  ...
  ka: {
    ...
    footer: {
      disclaimer: 'Citizen Report ხელს უწყობს პრობლემების მოგვარებას — ის არავის აჯარიმებს და ბრალს არ აკისრებს. ყველა საბოლოო გადაწყვეტილებას იღებენ უფლებამოსილი თანამდებობის პირები.',
    },
    status: {
