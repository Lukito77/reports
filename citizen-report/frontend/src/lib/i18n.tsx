...
const translations = {
  en: {
    ...
    installApp: {
      ...
      androidSubtitle: 'Add Reports to your home screen for quick access.',
      iosSubtitle: 'Open the Share menu in Safari and tap "Add to Home Screen".',
      installBtn: 'Install',
      dismiss: 'No thanks',
    },
    home: {
      ...
      closingTitle: 'Your report can change your street.',
      closingSubtitle: 'It takes less than five minutes — and no account is required to help clean up your city.',
    ...
    login: {
      ...
      otpToggle: 'Sign in with an email code',
      passwordToggle: 'Sign in with a password',
      otpTitle: 'Sign in with a code',
      otpSubtitle: "Enter your email and we'll send you a one-time sign-in code.",
      otpSend: 'Send code',
      otpSending: 'Sending…',
      otpSent: 'We emailed you a 6-digit code. Enter it below (valid for 10 minutes).',
      otpCodeLabel: 'Sign-in code',
      otpVerify: 'Verify & sign in',
      otpVerifying: 'Verifying…',
      otpChangeEmail: 'Use a different email',
      otpError: 'Could not send the code. Please try again.',
    },
    forgotPassword: {
  ...
  ka: {
    ...
    installApp: {
      title: 'ჩაიწერეთ აპლიკაცია',
      androidSubtitle: 'დაამატეთ Reports თქვენს მთავარ ეკრანზე სწრაფი წვდომისთვის.',
      iosSubtitle: 'გახსენით Safari-ს „გაზიარების" მენიუ და აირჩიეთ „მთავარ ეკრანზე დამატება".',
      installBtn: 'დაყენება',
      dismiss: 'არა, გმადლობთ',
    },
    home: {
      ...
      closingTitle: 'თქვენმა განაცხადმა შეიძლება შეცვალოს თქვენი ქუჩა.',
      closingSubtitle: 'დასჭირდებათ 5 წუთზე ნაკლები დრო — და ანგარიშიც არ არის საჭირო იმისთვის, რომ დაეხმაროთ თქვენს ქალაქს.',
    ...
    login: {
      ...
      otpToggle: 'შესვლა ელ-ფოსტის კოდით',
      passwordToggle: 'შესვლა პაროლით',
      otpTitle: 'შესვლა კოდით',
      otpSubtitle: 'შეიყვანეთ ელ-ფოსტა და გამოგიგზავნით ერთჯერად კოდს შესასვლელად.',
      otpSend: 'კოდის გაგზავნა',
      otpSending: 'იგზავნება…',
      otpSent: 'გამოგიგზავნეთ 6-ნიშნა კოდი ელ-ფოსტაზე. შეიყვანეთ ქვემოთ (მოქმედებს 10 წუთი).',
      otpCodeLabel: 'შესვლის კოდი',
      otpVerify: 'დადასტურება და შესვლა',
      otpVerifying: 'მოწმდება…',
      otpChangeEmail: 'სხვა ელ-ფოსტის გამოყენება',
      otpError: 'კოდის გაგზავნა ვერ მოხერხდა. გთხოვთ, სცადოთ თავიდან.',
    },
    forgotPassword: {
